...
class APPLEThread_3(QThread):
    ...
    def run(self):
        ...
        self.emit_progress("4-获取aid_1", self.row)
        ...
        self.emit_progress("13-aa_2", self.row)
        result_fourteen = self.apple_remove.fourteen()
        self.emit_progress("14-aa_3", self.row)
        ...
        self.emit_progress("28-过jslog", self.row)
        result_twenty_nine = self.apple_remove.twenty_nine()
        self.emit_progress("29-过jslog", self.row)
        result_thirty = self.apple_remove.thirty()
        self.emit_progress("30-过jslog", self.row)
        ...
        self.emit_progress("33-过jslog", self.row)
        result_thirty_four = self.apple_remove.thirty_four()
        self.emit_progress("34-过jslog", self.row)
